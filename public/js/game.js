...
window.openCustomization = function() {
  ...
  if (window.dinoGame) {
    ...
    if (themeSelect) themeSelect.value = window.dinoGame.settings.backgroundTheme;
    if (soundToggle) soundToggle.checked = window.dinoGame.settings.soundEnabled;
    if (difficultySelect) difficultySelect.value = window.dinoGame.settings.difficultyPreference;
  }
};
